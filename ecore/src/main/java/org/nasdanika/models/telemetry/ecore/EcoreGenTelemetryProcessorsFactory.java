package org.nasdanika.models.telemetry.ecore;
...
@EPackageNodeProcessorFactory(nsURI = org.nasdanika.telemetry.model.ModelPackage.eNS_URI)
public class EcoreGenTelemetryProcessorsFactory {

	private Context context;
		
	public EcoreGenTelemetryProcessorsFactory(Context context) {
		...
		return new EPackageNodeProcessor(config, context, prototypeProvider) {
			...
			protected void generateDiagramAndGraphActions(Collection<Label> labels, ProgressMonitor progressMonitor) {
				...
				try {
					...
					Files.writeString(new File("target/telemetry.drawio").toPath(), document.save(null));
				} catch (Exception e) {
					e.printStackTrace();
