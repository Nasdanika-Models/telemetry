 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.telemetry.SummaryDataPoint#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.SummaryDataPoint#getStartTimeUnixNano <em>Start Time Unix Nano</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.SummaryDataPoint#getTimeUnixNano <em>Time Unix Nano</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.SummaryDataPoint#getCount <em>Count</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.SummaryDataPoint#getSum <em>Sum</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.SummaryDataPoint#getQuantileValues <em>Quantile Values</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.SummaryDataPoint#getFlags <em>Flags</em>}</li>
 * </ul>
 *
 * @see org.nasdanika.models.telemetry.TelemetryPackage#getSummaryDataPoint()
 * @model
 * @generated
 */
public interface SummaryDataPoint extends EObject {
	 ...
	 * @see org.nasdanika.models.telemetry.TelemetryPackage#getSummaryDataPoint_Attributes()
	 ...
	 * @see org.nasdanika.models.telemetry.TelemetryPackage#getSummaryDataPoint_StartTimeUnixNano()
	 * @model unique="false"
	 * @generated
	 */
	 ...
	 * @see org.nasdanika.models.telemetry.TelemetryPackage#getSummaryDataPoint_TimeUnixNano()
	 * @model unique="false"
	 * @generated
	 */
	 ...
	 * @see #setCount(long)
	 * @see org.nasdanika.models.telemetry.TelemetryPackage#getSummaryDataPoint_Count()
	 * @model unique="false"
	 * @generated
	 */
	long getCount();
	 ...
	 * @see #setSum(double)
	 * @see org.nasdanika.models.telemetry.TelemetryPackage#getSummaryDataPoint_Sum()
	 * @model unique="false"
	 * @generated
	 */
	double getSum();
	 ...
	 * The list contents are of type {@link org.nasdanika.models.telemetry.SummaryDataPointValueAtQuantile}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Quantile Values</em>' containment reference list.
	 * @see org.nasdanika.models.telemetry.TelemetryPackage#getSummaryDataPoint_QuantileValues()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see #setFlags(int)
	 * @see org.nasdanika.models.telemetry.TelemetryPackage#getSummaryDataPoint_Flags()
	 * @model unique="false"
	 * @generated
	 */
	int getFlags();
