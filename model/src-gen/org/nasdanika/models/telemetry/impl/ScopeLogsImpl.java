 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.telemetry.impl.ScopeLogsImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.impl.ScopeLogsImpl#getLogRecords <em>Log Records</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.impl.ScopeLogsImpl#getSchemaUrl <em>Schema Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScopeLogsImpl extends MinimalEObjectImpl.Container implements ScopeLogs {
	...
	public NotificationChain basicSetScope(InstrumentationScope newScope, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newScope, TelemetryPackage.SCOPE_LOGS__SCOPE, msgs);
		return msgs;
	}
