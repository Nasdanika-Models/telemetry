 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.telemetry.impl.ScopeMetricsImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.impl.ScopeMetricsImpl#getMetrics <em>Metrics</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.impl.ScopeMetricsImpl#getSchemaUrl <em>Schema Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScopeMetricsImpl extends MinimalEObjectImpl.Container implements ScopeMetrics {
	...
	public NotificationChain basicSetScope(InstrumentationScope newScope, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newScope, TelemetryPackage.SCOPE_METRICS__SCOPE, msgs);
		return msgs;
	}
