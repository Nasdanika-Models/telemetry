 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.telemetry.impl.ScopeSpansImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.impl.ScopeSpansImpl#getSpans <em>Spans</em>}</li>
 *   <li>{@link org.nasdanika.models.telemetry.impl.ScopeSpansImpl#getSchemaUrl <em>Schema Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScopeSpansImpl extends MinimalEObjectImpl.Container implements ScopeSpans {
	...
	public NotificationChain basicSetScope(InstrumentationScope newScope, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newScope, TelemetryPackage.SCOPE_SPANS__SCOPE, msgs);
		return msgs;
	}
